...
export const dishes: Dish[] = [
    ...
    // Yogurt Bowls
    { id: 'berry-yogurt', name: 'Ягодный микс', description: 'Греческий йогурт · клубника · голубика · гранат · мюсли · чиа · мёд', weight: '300 г', price: 290, photo: 'https://images.unsplash.com/photo-1511690743698-d9d18f7e20f1?w=400&h=300&fit=crop', categoryId: 'yogurt-bowls' },
