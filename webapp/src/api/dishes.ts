...
const dishes: Dish[] = [
    ...
    // ═══════ ПОКЕ — Йогурт-боулы ═══════
    { id: 'berry-yogurt', name: 'Ягодный микс', description: 'Греческий йогурт · свежая клубника · голубика · гранат · мюсли · семена чиа · мёд', weight: '300 г', price: 290, photo: 'https://images.unsplash.com/photo-1757450296755-f875c2dc80bf?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0', categoryId: 'yogurt-bowls' },
    ...
    { id: 'carrot-juice', name: 'Морковный', description: '', weight: '300 мл', price: 120, photo: 'https://images.unsplash.com/photo-1753991532697-9053a0a200ea?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0', categoryId: 'fresh-juice' },
    { id: 'apple-juice', name: 'Яблочный', description: '', weight: '300 мл', price: 120, photo: 'https://images.unsplash.com/photo-1754242203534-b5c19d2272fe?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0', categoryId: 'fresh-juice' },
    ...
    { id: 'pineapple-juice', name: 'Ананасовый', description: '', weight: '300 мл', price: 120, photo: 'https://images.unsplash.com/photo-1754325233917-d9bfd5441e61?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0', categoryId: 'fresh-juice' },
    ...
    { id: 'watermelon-shake', name: 'Арбузный', description: '', weight: '350 мл', price: 100, photo: 'https://images.unsplash.com/photo-1754325264731-16180f674fa6?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0', categoryId: 'shakes' },
    ...
    { id: 'mango-shake', name: 'Манго', description: '', weight: '350 мл', price: 120, photo: 'https://images.unsplash.com/photo-1754008411196-890c4cf83dc9?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0', categoryId: 'shakes' },
    { id: 'banana-shake', name: 'Банановый', description: '', weight: '350 мл', price: 100, photo: 'https://images.unsplash.com/photo-1753722295237-ab0c231eef95?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0', categoryId: 'shakes' },
    { id: 'dragonfruit-shake', name: 'Драгонфрут', description: '', weight: '350 мл', price: 120, photo: 'https://images.unsplash.com/photo-1753722157947-8a50f04a9309?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0', categoryId: 'shakes' },
    { id: 'passion-fruit-shake', name: 'Маракуйя', description: '', weight: '350 мл', price: 120, photo: 'https://images.unsplash.com/photo-1753795350160-6ade01b1d657?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0', categoryId: 'shakes' },
    ...
    { id: 'mix-shake', name: 'Микс (любой)', description: '', weight: '350 мл', price: 120, photo: 'https://images.unsplash.com/photo-1753623716198-e07dddefcd1a?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0', categoryId: 'shakes' },
    ...
    { id: 'passion-orange', name: 'Маракуйя-апельсин', description: '', weight: '400 мл', price: 120, photo: 'https://images.unsplash.com/photo-1753623712508-0359fa78ffee?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0', categoryId: 'lemonade' },
    { id: 'butterfly-pea', name: 'Анчан-лайм', description: '', weight: '400 мл', price: 120, photo: 'https://images.unsplash.com/photo-1753644552542-6010baf263a6?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0', categoryId: 'lemonade' },
    ...
    { id: 'blue-lagoon', name: 'Голубая лагуна', description: '', weight: '400 мл', price: 150, photo: 'https://images.unsplash.com/photo-1753644551456-ce4e9a95dd98?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0', categoryId: 'mocktails' },
    { id: 'sunrise', name: 'Санрайз', description: '', weight: '400 мл', price: 150, photo: 'https://images.unsplash.com/photo-1750665645109-6b2b84bf5abd?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0', categoryId: 'mocktails' },
